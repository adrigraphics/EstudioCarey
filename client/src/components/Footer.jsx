...
export default function Footer() {
  return (
    <footer className="nunito footer px-5 lg:px-24 2xl:px-36 items-center justify-items-center md:justify-items-start w-full p-4 bg-black text-white">
      ...
      <div className="tooltip tooltip-open tooltip-error  grid-flow-col gap-4 md:place-self-center md:justify-self-end" data-tip="Síguenos!">
      <div className='flex flex-row'>
          <a href="https://www.instagram.com/adrigraphics" target="_blank" className="tooltip tooltip-primary tooltip-left hover:scale-110 hover:ease-in-out hover:transition" data-tip="Adri">
            <div className="avatar online">
              <div className="w-12 rounded-full ring ring-primary ring-offset-base-100 ring-offset-2 mt-2">
                <img src={avatar_adri} />
              </div>
            </div>
          </a>
