...
const Producto = () => {
  ...
  return (
    <div className='producto nunito flex flex-col justify-center items-center py-[100px] animate__animated animate__fadeIn'>
      ...
      <div className='description max-w-[1000px]'>
